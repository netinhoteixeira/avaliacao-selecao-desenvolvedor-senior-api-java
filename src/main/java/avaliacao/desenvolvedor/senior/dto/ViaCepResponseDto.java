...
public class ViaCepResponseDto implements Serializable {
    ...
    private static final long serialVersionUID = -7732193707808955830L;
    ...
    @Schema(description = "Localidade.", example = "Brasília", required = true)
    private String localidade;

    @Schema(description = "Unidade Federativa.", example = "DF", required = true)
    private String uf;

    @Schema(description = "Código do IBGE.", example = "5300108")
    private String ibge;

    @Schema(description = "Código do GIA.")
    private String gia;

    @Schema(description = "Código do DDD.", example = "61")
    private String ddd;

    @Schema(description = "Código do SIAFI.", example = "9701")
